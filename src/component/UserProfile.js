...
const UserProfile = () => {
	...
	useEffect(() => {
		const fetchUser = async () => {
			try {
				const response = await fetch('https://auth-backend-rhn8.onrender.com/api/auth/getuser', {
					method: 'POST',
					headers: {
	...
	return (
		<div className='container d-flex justify-content-center'>
			<div className="card-client mt-5">
				...
				<p className="name-client">{user ? user.name : 'Loading...'}
					<span>{user ? user.email : 'Loading...'}
					</span>
				</p>
