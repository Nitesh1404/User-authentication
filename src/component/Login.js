...
const Login = () => {
	...
	const handleSubmit = async (e) => {
		e.preventDefault();
		try {
			const response = await fetch('https://auth-backend-rhn8.onrender.com/api/auth/login', {
				method: 'POST',
				headers: {
	...
	return (
		<div className='container d-flex justify-content-center align-items-center flex-column'>
			<h2 className='my-5' style={{ fontWeight: "bold" }}>Login</h2>
			{/* <hr /> */}
			...
			<form className="form" onSubmit={handleSubmit}>
				...
				<div className="inputForm">
					...
					{/* <svg viewBox="0 0 576 512" height="20" xmlns="http://www.w3.org/2000/svg">
						<path d="M419.404,58.936l-82.933,67.896c-23.335-14.586-50.919-23.012-80.471-23.012c-66.729,0-123.429,42.957-143.965,102.724l-83.397-68.276h-0.014C71.23,56.123,157.06,0,256,0C318.115,0,375.068,22.126,419.404,58.936z" />
					</svg> */}
				</div>
